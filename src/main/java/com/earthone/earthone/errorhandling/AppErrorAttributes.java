package com.earthone.earthone.errorhandling;

import io.jsonwebtoken.ExpiredJwtException;
import io.jsonwebtoken.MalformedJwtException;
import io.jsonwebtoken.SignatureException;
import com.earthone.earthone.exception.ApiException;
import com.earthone.earthone.exception.AuthException;
import com.earthone.earthone.exception.UnauthorizedException;
...
public class AppErrorAttributes extends DefaultErrorAttributes {
    ...
    public Map<String, Object> getErrorAttributes(ServerRequest request, ErrorAttributeOptions options) {
        ...
        if (error instanceof AuthException || error instanceof UnauthorizedException || error instanceof SignatureException || error instanceof MalformedJwtException) {
